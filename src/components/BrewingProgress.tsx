...
export function BrewingProgress({
  ...
  return (
    <div
      className={`rounded-xl border border-[var(--border-glow)] bg-[var(--bg-surface)] p-6 shadow-[inset_0_0_24px_rgba(224,142,54,0.06)] ${className}`}
      role="status"
      aria-label={label}
    ...
    >
      <div className="flex flex-col items-center gap-4">
        ...
        <div className="relative h-24 w-16 overflow-hidden rounded-b-lg border-2 border-[var(--accent-amber)]/40 bg-[var(--bg-base)]">
          <motion.div
        ...
        <p
          className="text-center font-medium text-[var(--text-primary)]"
